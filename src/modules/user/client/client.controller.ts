...
import { User as Client, UserBasicInfo as ClientBasicInfo } from "../user.type";
import { validateClient, validateClientUpdate } from "./client.validator";
import { CustomError } from "../../../errors";
import {
  getLocationNameFromCoordinates,
  getLocationNameFromPincode,
} from "../../../services/google-maps/location.service";
